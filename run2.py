#!/usr/bin/env python3
"""
Arduino Upload Script (Custom Encoder Version)
Usage: python run2.py <n-m>
       python run2.py stop
Example: python run2.py 1-1     (uploads code2/p1-1.cpp)
         python run2.py 1-2     (uploads code2/p1-2.cpp)
         python run2.py stop    (uploads code2/stop.cpp)
"""
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python run2.py <n-m>")
        print("       python run2.py stop")
        print("       python run2.py kp    (Kp Tuning Automation)")
        print("       python run2.py kd    (Kd Tuning Automation)")
        print("       python run2.py test  (Encoder Debug)")
        print("       python run2.py inputs (Input Debug)")
        print("Example: python run2.py 1-1")
        sys.exit(1)

    arg = sys.argv[1]

    # File paths - USE CODE2 DIRECTORY
    script_dir = Path(__file__).parent
    code_dir = script_dir / "code2"
